...
<template>
  <div :class="`language-${type}`" class="w-130">
    <pre ref="preEle" class="line-numbers match-braces" :class="`language-${type}`" :style="{ height: collapse ? '30px' : undefined, overflow: collapse ? 'hidden' : undefined }">
